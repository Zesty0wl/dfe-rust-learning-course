...
> 💡 **How to run the examples in this session.** Every example below lives in its own folder under `month-2/session-13/examples/`. From a fresh terminal **at the root of the repo**, run:
>
> ```bash
> cd month-2/session-13/examples/<example-folder>
> cargo run
> ```
>
