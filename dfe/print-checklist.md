...
| **After Session 8** | Milestone README (`sand-sim` v0.1) | [`../month-1/milestone/sand-sim-v0.1/README.md`](../month-1/milestone/sand-sim-v0.1/README.md) |
| **After Session 16** | Milestone 2 reflection (filled in) | [`milestone-2-reflection.md`](./milestone-2-reflection.md) |
| **After Session 16** | Milestone README (`sand-sim` v0.2) | [`../month-2/milestone/sand-sim-v0.2/README.md`](../month-2/milestone/sand-sim-v0.2/README.md) |
| **After Session 24** | Milestone 3 reflection (filled in) | [`milestone-3-reflection.md`](./milestone-3-reflection.md) |
| **After Session 24** | Milestone README (`sand-sim` v1.0) | [`../month-3/milestone/sand-sim-v1.0/README.md`](../month-3/milestone/sand-sim-v1.0/README.md) |
...
| **Before handover** *(optional, helpful for assessors with no chemistry background)* | Chemistry primer — combustion, phase change, oxidation in 10 minutes | [`../CHEMISTRY-PRIMER.md`](../CHEMISTRY-PRIMER.md) |
...
5. **Milestone 1 reflection** + `sand-sim` v0.1 README
6. **Milestone 2 reflection** + `sand-sim` v0.2 README
7. **Milestone 3 reflection** + `sand-sim` v1.0 README
...
- **Print one short code listing per milestone** — one nice page of `src/main.rs` from each `sand-sim` release, so the assessor can see your code without opening a laptop.
- **Print a screenshot** of each milestone running — v0.1 with a sand-and-water scene; v0.2 with fire spreading through wood; v1.0 with the codex partly filled in.
- **Add a clear plastic A4 wallet** at the back containing a USB stick with the full repo. The assessor can then watch the sim run if they'd like — `cd month-3/milestone/sand-sim-v1.0 && cargo run --release`.
